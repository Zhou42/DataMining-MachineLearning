...
legend('Max-Train','Max-Validation','Avg-Train','Avg-Validation','Proposed Stochastic-Train','Proposed Stochastic-Validation')
xlabel('Epochs');
ylabel('% Error');
axis([0 200 0 40]);
...
% plot((1 - trainingError_maxPool_50Dropout_augmentData - 0.02) *100,'g');
% 
% load('validationError_maxPool_50Dropout_augmentData');
% plot((1 - validationError_maxPool_50Dropout_augmentData -0.02) * 100,'g');
